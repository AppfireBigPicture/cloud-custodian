...
# Query the SSM Parameter Store for the SQS ARN
data "aws_ssm_parameter" "cloudcustodian_mailer_sqs" {
  name            = "/your/parameter/path"
  with_decryption = false
}

# Create the IAM policy using the SSM value as the resource ARN
